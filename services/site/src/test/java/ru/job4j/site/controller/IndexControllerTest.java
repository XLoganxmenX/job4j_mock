...
class IndexControllerTest {
    ...
    void whenGetIndexPageExpectModelAttributeThenOk() throws JsonProcessingException {
        ...
        var firstSubmitter = new ProfileDTO(1, "Test1", "new1", 1,
                Calendar.getInstance(), Calendar.getInstance());
        var secondSubmitter = new ProfileDTO(2, "Test2", "new2", 1,
                Calendar.getInstance(), Calendar.getInstance());
        var usernames = Map.of(firstSubmitter.getId(), firstSubmitter.getUsername(),
                            secondSubmitter.getId(), secondSubmitter.getUsername());
